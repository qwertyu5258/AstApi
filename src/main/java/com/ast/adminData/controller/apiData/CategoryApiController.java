...
public Map dp_cm_category_save() {

    Map<String, Object> DataList = restService.postApi("/dp/cm/category/save");

    return DataList;
}
//    dp_cm_category_update	분류 항목 수정	post	/dp/cm/category/update/{}
@PostMapping(value = {"/dp/cm/category/update/{param1}"})
public Map dp_cm_category_update(@PathVariable String param1) {

    Map<String, Object> DataList = restService.postApi("/dp/cm/category/update/" + param1);

    return DataList;
}
//    dp_cm_category_del	분류 항목 삭제	post	/dp/cm/category/delete/{}
@PostMapping(value = {"/dp/cm/category/delete/{param1}"})
public Map dp_cm_category_del(@PathVariable String param1) {

    Map<String, Object> DataList = restService.postApi("/dp/cm/category/delete/" + param1);
...
public Map dp_cm_category_del_chk(@PathVariable String param1) {

    Map<String, Object> DataList = restService.postApi("/dp/cm/category/delete/check/" + param1);
