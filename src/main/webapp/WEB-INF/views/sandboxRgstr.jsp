              ...
              <div class="x_panel"> 
                ...
                <div class="x_content"> <br>
                  <div class="scenario_depth"> 
                    <ul>
                      <li class="now_depth">샌드박스 설정</li>
                      <li class="temporary_storage">시나리오 선택</li>
                      <li class="save">분석 방식 선택</li>
                    </ul>
                  </div>
                            ...
                            <table class="table table-striped table-bordered bulk_action">
                              ...
                              <thead>
                                <tr>
                                  <th>프로그램</th>
                                  <th>버전</th>
                                  <th>포트선택 <span class="red">*</span></th>
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  <td>Python</td>
                                  <td>2.7.6</td>
                                  <td class="duplicate_box"> 
                                    <input type="text">
                                    <button class="btn btn-sm btn-primary">포트선택</button>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                    ...
                    <div class="tab_item" id="tab-1">  
                      ...
                      <div class="row">
                        <div class="col-12 col-md-6 mx-0">
                          <h4 class="center_title"> 
                            <label for="cycle1">
                              <input class="flat" id="analyze1" type="radio" name="cycle" checked>1회성
                            </label>
                          </h4>
                        </div>
                        <div class="col-12 col-md-6 mx-0">
                          <h4 class="center_title"> 
                            <label for="cycle2">
                              <input class="flat" id="analyze1" type="radio" name="cycle">주기성(배치성)
                            </label>
                          </h4>
                        </div>
                      </div>
                      ...
                      <div class="d-flex mb-4"> 
                        <div class="radio mr-4">
                          <label for="">
                            <input class="flat" id="analyze1" type="radio" name="find" checked>분석
                          </label>
                        </div>
                        <div class="radio mr-4">
                          <label for="">
                            <input class="flat" id="analyze1" type="radio" name="find">재학습
                          </label>
                        </div>
                        <div class="radio mr-4">
                          <label for="">
                            <input class="flat" id="analyze1" type="radio" name="find">
                          </label>재학습 + 분석
                        </div>
                      </div>
                                  ...
                                  <td> 
                                    <div class="form-control_box">
                                      <div class="input-prepend input-group"><span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input class="form-control" id="single_cal1" type="text" name="reservation" value="2020.01.01">
                                      </div>
                                    </div>
                                  </td>
                                  <td> 
                                    <div class="form-control_box">
                                      <div class="input-prepend input-group"><span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input class="form-control" id="single_cal2" type="text" name="reservation" value="2020.01.01">
                                      </div>
                                    </div>
                                  </td>
                                </tr>
                              ...
                              <tbody> 
                                <tr> 
                                  ...
                                  <td class="d-flex"> 
                                    <div class="form-control_box">
                                      <div class="input-prepend input-group"><span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input class="form-control" id="single_cal3" type="text" name="reservation" value="2020.01.01">
                                      </div>
                                    </div><span> ~ </span>
                                    <div class="form-control_box">
                                      <div class="input-prepend input-group"><span class="add-on input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input class="form-control" id="single_cal4" type="text" name="reservation" value="2020.01.01">
                                      </div>
                                    </div>
                                  </td>
                                </tr>
